...
#define BLACK 1
#define WHITE -1
#define CHESSVALUE 212
#define KINGVALUE 484
#define MAXJUMP 16
...
int main(){
    ...
    while(true){
        ...
        if(!strncmp(Command, "TURN ", 4)){
            ...
            #endif
            if(clock() - timeOfTurn <= 181 && curStep <= 50) iterativeDeepening(bestVal);
            //currentTime = clock();
            printMove();
            #ifdef Debug
